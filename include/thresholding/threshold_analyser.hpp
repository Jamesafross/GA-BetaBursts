...
public:
    ...
    std::vector<double> lowpass_filter(const std::vector<double>& signal, double cutoff = 50.0) const;
    ...
    std::vector<int> burst_mask_from_intervals(const std::vector<std::pair<int, int>>& bursts, std::size_t length) const;
